...
const Admin = () => {
  const [token, setToken] = useState(() => typeof window !== "undefined" ? sessionStorage.getItem : () => null(ADMIN_KEY) || "");
      ...
      <main className="min-h-screen bg-background flex items-center justify-center px-4">
        ...
        >
          <div className="flex flex-col items-center gap-2">
            <img src={logo} alt={`${APP_NAME} logo`} className="h-16 w-16 object-contain" />
          ...
          <Link to="/" className="block text-center text-xs underline text-muted-foreground hover:text-foreground">
